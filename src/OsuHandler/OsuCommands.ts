...
class OsuCommands {
  commandsList = {
    ...
    votechangemode: `(playerName: string) // Use it to switch the lobby's mode between "Host Rotate" and "Random Map" when all the players in the lobby vote for it, the parameter must be the playerName`,
